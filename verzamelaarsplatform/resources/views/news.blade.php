...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <script>
            ...
            var content = element.querySelector('.news-content');
    ...
    <div class="bg-[#121212] h-full w-full absolute">
        ...
        <div class="h-screen flex items-center mr-50 justify-center">
            <div class="z-10 bg-blue p-10 rounded shadow-md">
                <p class="text-xl pb-4 text-white font-semibold">News</p>

                @foreach($news as $newsItem)
        <div class="news-item bg-white text-black text-xl p-10 mb-4 rounded relative">
            <h2 class="mb-4">Titel: {{ $newsItem->titel }}</h2>
            <p class="text-blue-500 cursor-pointer" onclick="toggleNewsContent(this)">Lees meer</p>
            <div class="news-content hidden absolute left-0 bg-white p-4 mt-2 border rounded">
                <p>Inhoud: {{ $newsItem->inhoud }}</p>
