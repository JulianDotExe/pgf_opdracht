        ...
        @if (Route::has('login'))
            <div class="flex items-center justify-between bg-[#1F2937] p-1 shadow-md">
                ...
                <div class="flex-grow flex items-center justify-center space-x-10">
                    <a href="{{ url('/welcome') }}" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500"><u>Home</u></a>
                ...
                <div class="flex items-center">
                    ...
                    @else
                        ...
                        @if (Route::has('request'))
                            <a href="{{ route('request') }}" class="ml-4 font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Request account</a>
                        @endif
                    @endauth
                </div>
            </div>
