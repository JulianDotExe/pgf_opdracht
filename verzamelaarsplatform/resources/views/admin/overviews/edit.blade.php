    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('admin.overviews.update', $overview) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    ...
                    <br> <br>                    
                    <a href="{{ route('admin.overviews.index') }}" class="bg-blue-500 text-white py-1 px-2 rounded inline-block hover:bg-blue-700 transition duration-300 ease-in-out">Terug</a>
    ...
    <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
        <div class="bg-white p-8 rounded-md shadow-md w-1/2 flex flex-col items-center">
            ...
            <div class="flex justify-center w-full">
                ...
                <a href="{{ route('admin.overviews.index') }}" class="bg-red-500 text-white px-4 py-2 rounded hover:bg-red-700 transition duration-300 ease-in-out">Bevestigen</a>
            </div>
        </div>
    </div>
