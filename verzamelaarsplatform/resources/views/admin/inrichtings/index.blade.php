<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <a href="{{ route('admin.inrichtings.create') }}" class="bg-blue-500 text-white p-3 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Inrichting toevoegen</a>

            <div class="my-6">
                <a href="{{ route('admin.inrichtings.index', ['type' => 'sorts']) }}" class="bg-blue-500 text-white p-1 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Toon Soorten</a>
                <a href="{{ route('admin.inrichtings.index', ['type' => 'brands']) }}" class="bg-blue-500 text-white p-1 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Toon Merken</a>
                <a href="{{ route('admin.inrichtings.index', ['type' => 'epoches']) }}" class="bg-blue-500 text-white p-1 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Toon Epoches</a>
                <a href="{{ route('admin.inrichtings.index', ['type' => 'owners']) }}" class="bg-blue-500 text-white p-1 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Toon Eigenaren</a>
                <a href="{{ route('admin.inrichtings.index', ['type' => 'colors']) }}" class="bg-blue-500 text-white p-1 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Toon Kleuren</a>
                <a href="{{ route('admin.inrichtings.index', ['type' => 'categories']) }}" class="bg-blue-500 text-white p-1 rounded inline-block hover:bg-blue-600 transition duration-300 ease-in-out">Toon Categorieën</a>
            </div>
                        ...
                        <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
                            <div class="bg-white p-8 rounded-md shadow-md">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <form id="deleteForm" method="POST" action="{{ route('admin.inrichtings.destroySort', $sort->id) }}" class="inline">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
                            <div class="bg-white p-8 rounded-md shadow-md">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <form id="deleteForm" method="POST" action="{{ route('admin.inrichtings.destroyBrand', $brand->id) }}" class="inline">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
                            <div class="bg-white p-8 rounded-md shadow-md">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <form id="deleteForm" method="POST" action="{{ route('admin.inrichtings.destroyEpoche', $epoche->id) }}" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Bevestigen</button>
                                    </form>
                        ...
                        <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
                            <div class="bg-white p-8 rounded-md shadow-md">
                                ...
                                <div class="flex justify-between">
                                    ...
                                    <form id="deleteForm" method="POST" action="{{ route('admin.inrichtings.destroyOwner', $owner->id) }}" class="inline">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Bevestigen</button>
                                    </form>
                            ...
                            <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
                                <div class="bg-white p-8 rounded-md shadow-md">
                                    ...
                                    <div class="flex justify-between">
                                        ...
                                        <form id="deleteForm" method="POST" action="{{ route('admin.inrichtings.destroyColor', $color->id) }}" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Bevestigen</button>
                                        </form>
                                ...
                                <div id="confirmationPopup" class="fixed top-0 left-0 w-full h-full bg-gray-800 bg-opacity-50 flex items-center justify-center" style="display: none;">
                                    <div class="bg-white p-8 rounded-md shadow-md">
                                        ...
                                        <div class="flex justify-between">
                                            ...
                                            <form id="deleteForm" method="POST" action="{{ route('admin.inrichtings.destroyCategory', $category->id) }}" class="inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded">Bevestigen</button>
                                            </form>
    ...
    <script>
        function deleteOpenConfirmationPopup(itemId, type) {
            ...
            if (type === 'sorts') {
                form.action = "{{ route('admin.inrichtings.destroySort', '') }}" + '/' + itemId;
            } else if (type === 'brands') {
                form.action = "{{ route('admin.inrichtings.destroyBrand', '') }}" + '/' + itemId;
            } else if (type === 'epoches') {
                form.action = "{{ route('admin.inrichtings.destroyEpoche', '') }}" + '/' + itemId;
            } else if (type === 'owners') {
                form.action = "{{ route('admin.inrichtings.destroyOwner', '') }}" + '/' + itemId;
            } else if (type === 'colors'){
                form.action = "{{ route('admin.inrichtings.destroyColor', '') }}" + '/' + itemId;    
            } else if (type === 'categories') {
                form.action = "{{ route('admin.inrichtings.destroyCategory', '') }}" + '/' + itemId;
            }
