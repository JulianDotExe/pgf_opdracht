        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mx-auto mt-4">
                ...
                <div class="my-4 p-4 bg-white rounded-lg">
                    ...
                    <form action="{{ route('admin.inrichtings.createSort') }}" method="post" class="mt-2">
                        @csrf
                ...
                <div class="my-4 p-4 bg-white rounded-lg">
                    ...
                    <form action="{{ route('admin.inrichtings.createBrand') }}" method="post" class="mt-2">
                        @csrf
                ...
                <div class="my-4 p-4 bg-white rounded-lg">
                    ...
                    <form action="{{ route('admin.inrichtings.createEpoche') }}" method="post" class="mt-2">
                        @csrf
                ...
                <div class="my-4 p-4 bg-white rounded-lg">
                    ...
                    <form action="{{ route('admin.inrichtings.createOwner') }}" method="post" class="mt-2">
                        @csrf
                ...
                <div class="my-4 p-4 bg-white rounded-lg">
                    ...
                    <form action="{{ route('admin.inrichtings.createColor') }}" method="post" class="mt-2">
                        @csrf
                ...
                <div class="my-4 p-4 bg-white rounded-lg">
                    ...
                    <form action="{{ route('admin.inrichtings.createCategorie') }}" method="post" class="mt-2">
                        @csrf
                ...
                <a href="{{ route('admin.inrichtings.index') }}" class="bg-blue-500 text-white py-2 px-4 rounded inline-block hover:bg-blue-700 transition duration-300 ease-in-out">Terug</a>
