        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @forelse($news as $new)
                <div class="my-6 p-6 bg-white border-b border-gray-200 shadow-sm sm:rounded-lg">
                    ...
                    <!-- Verwijderknop -->
                    <form method="POST" action="{{ route('admin.news.destroy', $new->new_id) }}" class="inline">
                        @csrf
                        @method('DELETE')
                    ...
                    <h1>
                        <a href="{{ route('admin.news.show', $new->new_id) }}" class="text-blue-500 hover:underline hover:text-blue-700 transition duration-300 ease-in-out">Meer details</a>
                    </h1>
