    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form action="{{ route('overviews.store') }}"method="post">
                ...
                <select name="brand_id" id="brand_id" class="w-full">
                ...
                <x-text-input type="text" name="catalogusnr" field="catalogusnr" placeholder="Catalogusnummer..." class="w-full" autocomplete="off" :value="@old('catalogusnr')" style="background-color: white;"></x-text-input> 
                
                    <br> <br>

                <select name="epoche_id" id="epoche_id" class="w-full">
                ...
                <x-text-input type="text" name="nummer" field="nummer" placeholder="Nummer..." class="w-full" autocomplete="off" :value="@old('nummer')" style="background-color: white;"></x-text-input>
                
                    <br> <br>

                <x-text-input type="text" name="eigenschappen" field="eigenschappen" placeholder="Eigenschappen..." class="w-full" autocomplete="off" :value="@old('eigenschappen')" style="background-color: white;"></x-text-input> 
                
                    <br> <br>

                <select name="owner_id" id="owner_id" class="w-full">
                ...
                <select name="color1_id" id="color1_id" class="w-full">
                ...
                <select name="color2_id" id="color2_id" class="w-full">
